      ...
      <div className="h-60 relative">
        ...
        <div className="absolute inset-0 flex items-end px-4">
          ...
          <div className="relative h-full w-full">
            <div className="absolute bottom-0 left-0 right-0 bg-blue-500/20 rounded-t-md" style={{ height: '65%' }}></div>
            <div className="absolute bottom-0 left-0 right-0 border-t-2 border-blue-500" style={{ height: '65%' }}>
          ...
          <div className="relative h-full w-full ml-1">
            <div className="absolute bottom-0 left-0 right-0 bg-teal-500/20 rounded-t-md" style={{ height: '80%' }}></div>
            <div className="absolute bottom-0 left-0 right-0 border-t-2 border-teal-500" style={{ height: '80%' }}>
          ...
          {/* English line */}
          <div className="relative h-full w-full ml-1">
            <div className="absolute bottom-0 left-0 right-0 bg-indigo-500/20 rounded-t-md" style={{ height: '55%' }}></div>
            <div className="absolute bottom-0 left-0 right-0 border-t-2 border-indigo-500" style={{ height: '55%' }}>
