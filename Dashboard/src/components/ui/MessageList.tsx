  ...
  const messages = [
    {
      ...
      excerpt: 'I would like to discuss some updates to the mathematics curriculum for the next semester...',
      time: '10:30 AM',
      unread: true
    },
    {
      ...
      excerpt: 'Here is the updated reading list for the English Literature class...',
      time: 'Yesterday',
      unread: false
    },
    {
      ...
      excerpt: 'Michael will be absent tomorrow due to a doctor\'s appointment...',
      time: 'Yesterday',
      unread: false
    },
    {
      ...
      <div className="pt-4">
        ...
        <div className="space-y-4">
          {messages.map((message) => (
            <div 
              key={message.id} 
              className={`flex p-4 hover:bg-gray-50 rounded-lg cursor-pointer ${message.unread ? 'bg-blue-50' : ''}`}
            >
