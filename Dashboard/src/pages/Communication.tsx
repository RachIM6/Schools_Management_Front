        ...
        <div className="p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  <div className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <h4 className="text-md font-medium">End of Year Ceremony</h4>
                      <span className="text-xs text-gray-500">May 10, 2025</span>
                    </div>
                    <p className="text-sm text-gray-600 mt-2">
                      The End of Year Ceremony will be held on June 15th at 10:00 AM in the main auditorium. All parents are invited to attend.
                    </p>
                    <div className="mt-3 flex items-center text-xs text-gray-500">
                      <span className="px-2 py-1 rounded-full bg-green-100 text-green-800">All Classes</span>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <h4 className="text-md font-medium">Parent-Teacher Conference</h4>
                      <span className="text-xs text-gray-500">May 5, 2025</span>
                    </div>
                    <p className="text-sm text-gray-600 mt-2">
                      Parent-Teacher Conferences will be held on May 20-21. Please schedule your appointment through the parent portal.
                    </p>
                    <div className="mt-3 flex items-center text-xs text-gray-500">
                      <span className="px-2 py-1 rounded-full bg-blue-100 text-blue-800">10th Grade</span>
          ...
          {activeTab === 'email' && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-1">Email Integration</h3>
              <p className="text-gray-500 max-w-md mx-auto">
                Connect your email account to send emails directly from SchoolPulse.
              </p>
